...
public class tonghopmotmot extends AppCompatActivity {
    ImageButton bt, bth;
    ListView listView;
    TextView txttieude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(tonghopmotmot.this, webview.class);
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://cdn.24h.com.vn/upload/rss/suckhoedoisong.rss");
            }
        });
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://ngoisao.net/rss/lam-dep.rss");
            }
        });
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            tron(mangdocbao);
            customadapter = new Customadapter(tonghopmotmot.this, android.R.layout.simple_list_item_1, mangdocbao);
