...
import tonghoplist.tonghopmotmot;
...
public class tonghop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://vnexpress.net/rss/suc-khoe.rss");
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(tonghop.this, webview.class);
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate2().execute("https://cdn.24h.com.vn/upload/rss/suckhoedoisong.rss");
            }
        });
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate3().execute("https://ngoisao.net/rss/lam-dep.rss");
            }
        });
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter = new Customadapter(tonghop.this, android.R.layout.simple_list_item_1, mangdocbao);
    ...
    class Readdate2 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter2 = new Customadapter(tonghop.this, android.R.layout.simple_list_item_1, mangdocbao2);
    ...
    class Readdate3 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter3 = new Customadapter(tonghop.this, android.R.layout.simple_list_item_1, mangdocbao3);
    ...
    {
        Intent myIntent=new Intent(this, tonghopmotmot.class);
