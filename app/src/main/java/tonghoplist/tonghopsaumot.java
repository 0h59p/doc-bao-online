...
public class tonghopsaumot extends AppCompatActivity {
    ImageButton bt, bth;
    ListView listView;
    TextView txttieude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(tonghopsaumot.this, webview.class);
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://ngoisao.net/rss/chau-a.rss");
            }
        });
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            tron(mangdocbao);
            customadapter = new Customadapter(tonghopsaumot.this, android.R.layout.simple_list_item_1, mangdocbao);
