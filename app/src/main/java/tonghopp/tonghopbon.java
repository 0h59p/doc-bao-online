...
import tonghoplist.tonghopbonmot;
...
public class tonghopbon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://vnexpress.net/rss/giao-duc.rss");
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(tonghopbon.this, webview.class);
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate2().execute("https://cdn.24h.com.vn/upload/rss/giaoducduhoc.rss");
            }
        });
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate3().execute("https://ngoisao.net/rss/trac-nghiem.rss");
            }
        });
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter = new Customadapter(tonghopbon.this, android.R.layout.simple_list_item_1, mangdocbao);
    ...
    class Readdate2 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter2 = new Customadapter(tonghopbon.this, android.R.layout.simple_list_item_1, mangdocbao2);
    ...
    class Readdate3 extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter3 = new Customadapter(tonghopbon.this, android.R.layout.simple_list_item_1, mangdocbao3);
    ...
    {
        Intent myIntent=new Intent(this, tonghopbonmot.class);
